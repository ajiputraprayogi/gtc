                    ...
                    <div class="modal-body p-4">
                        <div class="text-center">
                            ...
                            @csrf
                                ...
                                <button type="submit" id="btneditaprovalkeu" class="btn btn-warning my-2">Simpan</button>
                            </form>
                            @endforeach
                        </div>
                    </div>
...
<script src="{{asset('customjs/backend/aproval-keu-pengajuan-gtc.js')}}"></script>
